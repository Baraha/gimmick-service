...
func ChainStreamServer(interceptors ...grpc.StreamServerInterceptor) grpc.StreamServerInterceptor {
	...
	return func(srv interface{}, serverStream grpc.ServerStream, info *grpc.StreamServerInfo, handler grpc.StreamHandler) error {
		...
		return chainedHandler(srv, serverStream)
	}
}
...
func ChainUnaryClient(interceptors ...grpc.UnaryClientInterceptor) grpc.UnaryClientInterceptor {
	...
	return func(ctx context.Context, method string, req, reply interface{}, clientConn *grpc.ClientConn,
		...
		return chainedInvoker(ctx, method, req, reply, clientConn, opts...)
	}
}
...
func ChainStreamClient(interceptors ...grpc.StreamClientInterceptor) grpc.StreamClientInterceptor {
	...
	return func(ctx context.Context, desc *grpc.StreamDesc, clientConn *grpc.ClientConn, method string,
		...
		return chainedStreamer(ctx, desc, clientConn, method, opts...)
	}
}
...
// WithUnaryClientChain is a grpc.Client config option that accepts multiple unary interceptors.
// Basically syntactic sugar.
...
// WithStreamClientChain is a grpc.Client config option that accepts multiple stream interceptors.
// Basically syntactic sugar.
